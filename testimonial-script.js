     ...
     $('head').append('<style>'+css_library+'</style>')
                     ...
                     var getTestimonialForm = function(config_form,id){
                       ...
                       var label_color = config_form.label_color != '' ? config_form.label_color : '',
                           ...
                           submit_button_bg = config_form.submit_button_color.background != '' ? config_form.submit_button_color.background : '',
                           submit_button_color_hv = config_form.submit_button_color.hover_color != '' ? config_form.submit_button_color.hover_color : '',
                           submit_button_bg_hv = config_form.submit_button_color.hover_background != '' ? config_form.submit_button_color.hover_background : '';
                       output_form += `<style>
...
color: #de7202;
                       ...
                       output_form += '<div id="testimonial_form_'+id+'" class="simesy-tpro-fronted-form"><form id="testimonial_form" name="testimonial_form" method="post" action="" enctype="multipart/form-data">';
                       if(config_form.redirect == 'same_page' && config_form.successful_message != '' && config_form.message_position[0] == 'top'){
                         output_form += '<div class="simesy-tpro-form-validation-msg hide">'+config_form.successful_message+'</div>';
                       }
                       $.each(form_fields,function(i,form_field){
                         switch (form_field){
                           case 'full_name':
                             if(form_field.includes('full_name')){
                               var full_name_label = config_form.full_name.label != '' ? config_form.full_name.label : '';
                               var full_name_required = config_form.full_name.required ? 'required' : '';
                           ...
                           case 'email_address':
                             if(form_field.includes('email_address')){
                               var email_address_label = config_form.email_address.label != '' ? config_form.email_address.label : '';
                               var email_address_required = config_form.email_address.required ? 'required' : '';
                               output_form += '<div class="simesy-tpro-form-field">';
                           ...
                           case 'identity_position':
                             if(form_field.includes('identity_position')){
                               var identity_position_label = config_form.identity_position.label != '' ? config_form.identity_position.label : '';
                               var identity_position_required = config_form.identity_position.required ? 'required' : '';
                               output_form += '<div class="simesy-tpro-form-field">';
                           ...
                           case 'company_name':
                             if(form_field.includes('company_name')){
                               var company_name_label = config_form.company_name.label != '' ? config_form.company_name.label : '';
                               var company_name_required = config_form.company_name.required ? 'required' : '';
                               output_form += '<div class="simesy-tpro-form-field">';
                           ...
                           case 'testimonial_title':
                             if(form_field.includes('testimonial_title')){
                               var testimonial_title_label = config_form.testimonial_title.label != '' ? config_form.testimonial_title.label : '';
                               var testimonial_title_required = config_form.testimonial_title.required ? 'required' : '';
                               output_form += '<div class="simesy-tpro-form-field">';
                           ...
                           case 'testimonial':
                             if(form_field.includes('testimonial')){
                               var testimonial_label = config_form.testimonial.label != '' ? config_form.testimonial.label : '';
                               var testimonial_required = config_form.testimonial.required ? 'required' : '';
                               output_form += '<div class="simesy-tpro-form-field">';
                           ...
                           case 'featured_image':
                             if(form_field.includes('featured_image')){
                               ...
                               output_form +='<input type="hide" name="tpro_client_image_url" id="tpro_client_image_url" style="display:none"/><input type="file" name="tpro_client_image" id="tpro_client_image" class="input-testi '+featured_image_required+'" accept="image/jpeg,image/jpg,image/png,"/><div class="image-valid-size" style="display:none">Size limit: (width <= 150px) and size (<= 250 KB)</div></div>';
                               output_form += '<img src="" id="image-fk" style="display:none;"/>'
                             }
                             break;
                           case 'location':
                             if(form_field.includes('location')){
                               var location_label = config_form.location.label != '' ? config_form.location.label : '';
                               var location_required = config_form.location.required ? 'required' : '';
                               output_form += '<div class="simesy-tpro-form-field">';
                               if ( location_label != '' ) {
                           ...
                           case 'phone_mobile':
                             if(form_field.includes('phone_mobile')){
                               var phone_mobile_label = config_form.phone_mobile.label != '' ? config_form.phone_mobile.label : '';
                               var phone_mobile_required = config_form.phone_mobile.required ? 'required' : '';
                               output_form += '<div class="simesy-tpro-form-field">';
                           ...
                           case 'website':
                             if(form_field.includes('website')){
                               var website_label = config_form.website.label != '' ? config_form.website.label : '';
                               var website_required = config_form.website.required ? 'required' : '';
                               output_form += '<div class="simesy-tpro-form-field">';
                               if ( website_label != '' ) {
                           ...
                           case 'video_url':
                             if(form_field.includes('video_url')){
                               var video_url_label = config_form.video_url.label != '' ? config_form.video_url.label : '';
                               var video_url_required = config_form.video_url.required ? 'required' : '';
                               output_form += '<div class="simesy-tpro-form-field">';
                               if ( video_url_label != '' ) {
                           ...
                           case 'social_profile':
                             if(form_field.includes('social_profile')){
                               var social_profile_label = config_form.social_profile.label != '' ? config_form.social_profile.label : '';
                               output_form += '<div class="simesy-tpro-form-field">';
                               if ( social_profile_label != '' ) {
                                 output_form += '<label for="tpro_client_video_url">'+social_profile_label+'</label><br>';
                               }
                               output_form += '<div class="tpro-social-profile-wrapper"><div id="tpro-social-profiles">';
                               output_form += '<div class="tpro-social-profile-item" data-group="tpro_social_profiles">';
                               output_form += '<div class="tpro-social-profile-content"><div class="tpro-social-name-field">';
                               output_form += '<select class="tpro-social-name" data-name="social_name" placeholder="Select"><option value="">Select</option>';
                               if(config_form.social_profile.social_profile_list != ''){
                                 $.each(config_form.social_profile.social_profile_list,function(e,profile){
                                   output_form += '<option value="'+profile+'">'+profile+'</option>';
                                 })

                               }
                               output_form += '</select></div>';
                               output_form += '<div class="tpro-social-url-field"><input type="text" class="tpro-social-url" data-name="social_url" placeholder="Social URL"></div>';
                               output_form += '</div>';
                               output_form += '<div class="tpro-social-remove"><i class="tpro-social-profile-remove fa fa-times"></i></div>';
                               output_form += '</div></div>';
                               output_form += '<span class="tpro-add-new-profile-btn">Add New</span>';
                               output_form += '</div></div>';
                             }
                             break;
                           case 'rating':
                             if(form_field.includes('rating')){
                               var rating_label = config_form.rating.label != '' ? config_form.rating.label : '';
                               output_form += '<div class="simesy-tpro-form-field">';
                               if ( rating_label != '' ) {
                                 output_form += '<label for="tpro_client_rating">'+rating_label+'</label><br>';
                               }
                               output_form += '<div class="simesy-tpro-client-rating">';
                               output_form += '<input type="radio" name="tpro_client_rating" id="_tpro_rating_5" value="five_star"> <label for="_tpro_rating_5" title="Five Stars"><i class="fa fa-star"></i></label>';
                           ...
                           case 'recaptcha':
                             if(form_field.includes('recaptcha')){
                               var recaptcha_label = config_form.recaptcha.label != '' ? config_form.recaptcha.label : '';
                               output_form += '<div class="simesy-tpro-form-field">';
                               if ( recaptcha_label != '' ) {
                       ...
                       if(config_form.redirect == 'same_page' && config_form.successful_message != '' && config_form.message_position[0] == 'bottom'){
                         output_form += '<div class="simesy-tpro-form-validation-msg hide">'+config_form.successful_message+'</div>';
                       }
                     ...
                     function clearForm(){
                       ...
                       $('#testimonial_form .simesy-tpro-form-field input[type="radio"]').prop('checked',false);
                         ...
                         var initTestimonialSlider = function ($) {
                           ...
                           $(".simesy-testimonial-pro-section.simesy_testimonial_pro_filter").each((function(index) {
                             var filter_id = $(this).attr("id"),
                                 tpro_filter_config = $.parseJSON($(this).closest(".simesy-testimonial-pro-wrapper").find(".simesy-tpro-config").text()),
                                 winDow = $(window),
                                 $container = $("#" + filter_id + " .simesy-tpro-isotope-items"),
                                 $filter = $("#" + filter_id + " .simesy-tpro-filter");
                             try {
                               $container.imagesLoaded((function() {
                                 $container.show(), $container.isotope({
                                   filter: "*",
                             ...
                             filterItemA.on("click", (function() {
                               var $this = $(this);
                               $this.hasClass("active") || (filterItemA.removeClass("active"), $this.addClass("active"))
                             }))
                           }))
                           $(document).find("div[data-view-id]").each(function(){
                             ...
                             if($("#" + sliderID + " .simesy-testimonial-pro-section.infinite_scroll").length > 0){ 
                               $(window).scroll(function(e) {
                                 var scrollTop = $(window).scrollTop();
                                 $('.simesy-testimonial-pro-section.infinite_scroll .simesy-tpro-pagination-area:not(.loaded)').each(function(){
                                   var height = $(this).parents('.simesy-testimonial-pro-section').find('.simesy-testimonial-pro').height();
                                   var offset_down = $(this).find('.infinite-scroll-request').attr('data-down');
                                   if(jQuery(window).scrollTop() > offset_down){
                                     if($(this).offset().top < scrollTop + height && $(this).offset().top > scrollTop + height - 300){
                                           ...
                                           success: function (response) {
                                             ...
                                             setTimeout(function(){
                                               ...
                                               if(response.data.shortCode.config.layout[0] == 'masonry'){
                                                 $('.simesy-testimonial-pro-wrapper[data-view-id="'+id+'"]').find('.sp-tpro-items').masonry('destroy');
                                                 $('.simesy-testimonial-pro-wrapper[data-view-id="'+id+'"]').find('.sp-tpro-items').html(html)
                                               }else{
                                                 $('.simesy-testimonial-pro-wrapper[data-view-id="'+id+'"]').find('.sp-tpro-items').html(html);
                                               }
                                   ...
                                   $(this).find('.infinite-scroll-request').attr('data-down',jQuery(window).scrollTop());
                                 })
                               });
                             }

                             if($("#" + sliderID + " .simesy-testimonial-pro-section.ajax_load_more").length > 0){

                               $(document).on("click", ".simesy-tpro-pagination-area .tpro-items-load-more", (function(e) {
                                 var id = $(this).parents('.simesy-testimonial-pro-wrapper').data('view-id');
                                 ...
                                 if(current_page == total_page){$(this).hide();}
                               }))

                             }
                             if($("#" + sliderID + " .simesy-testimonial-pro-section.ajax_pagination").length > 0){
                               $(document).on("click", ".simesy-tpro-pagination-area a.page-numbers", (function(e) {
                                 e.preventDefault();
                                 e.stopPropagation();
                                 var id = $(this).parents('.simesy-testimonial-pro-wrapper').data('view-id');
                                 var this_parent = $(this).parents('.simesy-tpro-pagination-area');
                                 ...
                                 if(current_page > 1 && current_page != 1){
                                   pagination_html +='<li><a href="javascript:void(0)" class="prev page-numbers" data-link="p"><i class="fa fa-angle-left"></i></li>'
                                 }
                                 for(var i = 1; i <= total_page; i++){
                                   if(i == current_page){
                                     pagination_html +='<li><span aria-current="page" class="page-numbers current">'+i+'</span><li>';
                                   }else{
                                     pagination_html +='<li><a href="javascript:void(0)" class="page-numbers" data-link="'+i+'">'+i+'</a><li>';
                                   }

                                 }
                                 if(total_page > 1 && current_page < total_page){
                                   pagination_html +='<li><a href="javascript:void(0)" class="next page-numbers" data-link="m"><i class="fa fa-angle-right"></i></a></li>'
                                 }
                           ...
                           //Pagination
                                                                      ...
                                                                      var get_slider = function (config, id, testimonial_list,total_page) {
                                                                        ...
                                                                        if(config.layout[0] == 'masonry' || config.layout[0] == 'grid' || config.layout[0] == 'filter'){
                                                                          css += `
...
`;
                                                                        ...
                                                                        if ( layout_present == 'grid' || layout_present == 'masonry' || layout_present == 'list' ) {
                                                                          if(config.grid_pagination){
                                                                            ...
                                                                            var grid_pagination_colors_hover_color = config.grid_pagination_colors.hover_color != '' ? config.grid_pagination_colors.hover_color : '';
                                                                            var grid_pagination_colors_hover_background = config.grid_pagination_colors.hover_background != '' ? config.grid_pagination_colors.hover_background : '';
...
`
                                                                        ...
                                                                        if (layout_present == "filter"){
                                                                          class_layout += 'simesy-testimonial-pro-section tpro-layout-list-'+config.slider_mode[0]+' simesy-testimonial-pro-read-more tpro-readmore-'+config.testimonial_read_more_link_action[0]+'-'+config.testimonial_read_more+' simesy_testimonial_pro_filter tpro-style-'+theme_style+'';
...
autoplay: false,
                                                                        ...
                                                                        if(config.grid_pagination){
                                                                          ...
                                                                          if(layout_present == 'grid' && config.grid_pagination || layout_present == 'masonry' && config.grid_pagination || layout_present == 'list' && config.grid_pagination){
                                                                            var hide_pagi = config.tp_pagination_type == 'ajax_load_more' || config.tp_pagination_type == 'infinite_scroll' ? 'style="display:none"' : '';
                                                                            var pagination_html = '<ul class="simesy-tpro-pagination" '+hide_pagi+'>';
                                                                            var current_page = 1;
                                                                            html_theme += '<div class="tpro-col-xl-1 simesy-tpro-pagination-area" data-total="'+total_page+'" data-cur="'+current_page+'">';
                                                                            for(var i = 1; i <= total_page; i++){
                                                                              if(i == current_page){
                                                                                pagination_html +='<li><span aria-current="page" class="page-numbers current">'+i+'</span><li>';
                                                                              }else{
                                                                            ...
                                                                            if ( 'ajax_load_more' == config.tp_pagination_type || 'infinite_scroll' == config.tp_pagination_type ) {
                                                                              html_theme += '<div class="page-load-status">';
                                                                              html_theme += '<div class="loader-ellips infinite-scroll-request" data-down="0">';
                                                                              html_theme += '<p><span class="loader-ellips__dot"></span><span class="loader-ellips__dot"></span><span class="loader-ellips__dot"></span><span class="loader-ellips__dot"></span></p>';
                                                                              html_theme += '</div>';
                                                                              html_theme += '<p class="infinite-scroll-last" style="display:none">End of content</p><p class="infinite-scroll-error" style="display:none">No more testimonials to load</p>'
                                                                              html_theme += '</div>';
                                                                            }
                                                                            if ( 'ajax_load_more' == config.tp_pagination_type ) {
                                                                              html_theme += '<div class="tpro-items-load-more"><span>'+config.load_more_label+'</span></div>';
                                                                            }
                                                                            html_theme += '</div>';
                                                                          }
                                                                        }
                           ...
                           function html_theme_one(testi,config,id,index){
                             ...
                             if(config.layout[0] == "filter"){
                               html_fun += '<div class="simesy-testimonial-pro-item tpro-col-xl-'+config.columns.large_desktop+' tpro-col-lg-'+config.columns.desktop+' tpro-col-md-'+config.columns.laptop+' tpro-col-sm-'+config.columns.tablet+' tpro-col-xs-'+config.columns.mobile+' post-127 spt_testimonial type-spt_testimonial status-publish isotope-item">';
                             }
                             html_fun += '<div class="simesy-testimonial-pro">';
                             if(config.client_image && config.thumbnail_slider == false && testi.config.image_url != ''){
                               var image_sizes_custom_height = config.image_custom_size.height != '' ? config.image_custom_size.height : 120,
                                   image_sizes_custom_width = config.image_custom_size.width != '' ? config.image_custom_size.width : 120;
